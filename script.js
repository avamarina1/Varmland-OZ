...
"homePrices.repairsPrice":"från 250 kr","booking.eyebrow":"BOKA EN KONSULTATION",
    ...
    "contact.text":"Har du en fråga om ett plagg, en ändring eller en reparation? Du är välkommen att kontakta oss.",
...
"about.quote":"","about.services":"Read more about our services →","prices.seeAll":"See full price list →","booking.eyebrow":"BOOK A CONSULTATION",
    ...
    "contact.text":"Do you have a question about a garment, an alteration or a repair? You are welcome to contact us.",
...
"homePrices.repairsPrice":"от 250 кр.", "booking.eyebrow":"ЗАПИСАТЬСЯ НА КОНСУЛЬТАЦИЮ",
    ...
    "contact.text":"У вас есть вопрос об изделии, переделке или ремонте? Свяжитесь с нами.",
